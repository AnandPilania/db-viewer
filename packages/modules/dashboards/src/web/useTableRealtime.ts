...
// Duplicated verbatim from the host app's `@/hooks/useTableRealtime` so this
// package has no import reaching back into the app hosting it (same
// self-contained boundary as record-create's NewRowDialog).
