...
export function CommandPalette({ commands, onClose }: Props) {
    ...
    // Reset the selection whenever the query changes the result set — adjusted
    // during render (React's documented pattern for this, using state rather
    // than a ref to track the previous value: https://react.dev/learn/you-might-not-need-an-effect#adjusting-some-state-when-a-prop-changes)
    // rather than in an effect, so there's no extra frame where the old index
    // briefly points at a filtered-out command.
