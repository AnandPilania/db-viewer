...
// works: @db-viewer/driver-interface first (everything else depends on
...
// @db-viewer/driver-interface has to resolve on the real registry, and
...
// @db-viewer/driver-interface via "workspace:*" in source (never hand-edit
